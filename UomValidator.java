...
public class UomValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		//ValidationUtils.rejectIfEmptyOrWhitespace(errors, "uomType", "", "Select One Uom Type");
		...
		if(!Pattern.compile("[A-Z]{4,8}").matcher(uom.getUomModel()).matches()){
			errors.rejectValue("uomModel", "", "UOM Model should be 4-8 Upper case letters");
		}else if(service.isUomTypeNModelExist(uom)){
